...
## 2024-05-24 - Interactive Card Keyboard Parity
**Learning:** `group-hover` classes must be paired with `group-focus-visible` for keyboard users to receive the same interactive visual feedback as mouse users when focusing complex interactive elements like cards.
**Action:** Always pair Tailwind `group-hover:*` utility classes with their equivalent `group-focus-visible:*` classes.
