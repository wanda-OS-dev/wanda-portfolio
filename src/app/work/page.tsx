...
// Pre-allocate fallback category style to prevent inline object creation on cache miss
...
// Pre-allocate fallback array to prevent O(N) empty array instantiations in render loops
