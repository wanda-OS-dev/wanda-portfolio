...
// Pre-allocate empty array fallback to prevent inline instantiation overhead
const EMPTY_DESCRIPTION: string[] = [];
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-10 pb-24">
        ...
        >
          ...
          <div className="space-y-5">
            {(parsedDescriptionsMap.get(project.id) ?? (project.longDescription ? project.longDescription.split('\n\n') : EMPTY_DESCRIPTION)).map((para, i) => (
