              ...
              return (
                ...
                >
                  <Link
                    href={href}
                    aria-current={isActive ? "page" : undefined}
                    className={`text-4xl font-light transition-colors duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-gold focus-visible:ring-offset-4 focus-visible:ring-offset-brand-black rounded-sm ${
