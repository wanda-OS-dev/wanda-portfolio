...
export const projects: Project[] = [
  {
    ...
    year: '2025',
    description:
      'Inbound lead qualification and CRM handoff automation for a B2B workflow.',
    longDescription: `This project automated inbound lead triage, data enrichment, and CRM handoff for a B2B pipeline.

The focus was reliability and response speed: incoming leads are normalized, validated, and routed into follow-up workflows with clear escalation points.
...
Scope centered on practical workflow automation, not prototype demos.`,
  ...
  },
  {
    ...
    year: '2025',
    description:
      'Production-ready SaaS foundation with auth, billing, and operations dashboard.',
...
Built as a production baseline with a clear handover path for ongoing product work.`,
  ...
  },
  {
    ...
    year: '2025',
    description:
      'Order, CRM, and ERP synchronization pipeline with retries and monitoring.',
